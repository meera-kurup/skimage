...
def undo_preprocess(input):
    """
    Undoes preprocessing for autoencoder
    :param input: Inputs to unpreprocess
    """
...
def view_autoencoder_results(inputs, model, num_classes, split):
    """
    Uses Matplotlib to visualize autoencoder results.
    :param inputs: Inputs used for visualization
    :param model: Model used for visualization
    :param num_classes: Number of classes to visualize
    :param split: Number of training images for each 1000 images
    """
